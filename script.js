window.onload = function () {
  ...
  output_woman = `<p>Sveicināts, galvenais tehnoloģiju ministrs!
...
Pēdējā laikā mūsu valsts ${sector} ir saskārusies ar lieliem izaicinājumiem. Mēs esam pilnībā atkarīgi no ${technology}, un diemžēl mūsu rīki vairs nespēj darboties pareizi. Piemēram, mūsu jaunākais ${object} 
...
`;
  ...
  output_man = `<p>Sveicināts, galvenais tehnoloģiju ministrs!
